...
<html>
  ...
  <body>
    ...
    <div id="viewport" class="">
      ...
      <div id="kropp">
        <h1>
          Kostnaden för medlemsskap är 50kr/år.
				</h1>
        <p>
					Betala helst så snart som möjligt<br />
          <a href="https://ebas.sverok.se/signups/index/8318" style="color: white; text-decoration: underline;">Bli medlem i Hällen Gaming här</a>
        </p>
      </div>
    </div>
