...
<html>
  ...
  <body>
    ...
    <div id="viewport" class="">
      ...
      <div id="kropp">
        <h1>
          Pågående kampanjer är;
				</h1>
				<p>
					Johan Hs Rise of Tiamat som spelas nästan varje vecka <br/>
					Jacob Bs Princes of the Apocalypse som spelas lika ofta <br />
					Samt Otto Ts Curse of Strahd som spelas på ojämna veckor. <br />
					Vi öppnar fler grupper ifall vi blir många nog. <br />
				</p>
      </div>
    </div>
