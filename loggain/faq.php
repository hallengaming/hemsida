...
if(isset($_POST['question']) && !empty($_POST['question']) AND isset($_POST['answer']) && !empty($_POST['answer'])){

$datum = mysqli_escape_string($db, $_POST['question']);
$text = mysqli_escape_string($db, $_POST['answer']);
$user= $_SESSION['login_user'];

  mysqli_query($db, "INSERT INTO faq (question, answer, user) VALUES(
    ...
    <div class="container">
      ...
      <div class="content">
        <div class="panel" id="login">
          <h3>Svara på en fråga</h3>

          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" role="form">
            <div class="form-group">
              <label for="date">Fråga</label>
              <div class="input-icon icon-username"></div>
              <input autofocus="true" class="form-control" id="question" name="question" placeholder="Frågan" tabindex="1" type="text" />
            </div>
            <div class="form-group">
              <label for="text">Svar</label>
              <div class="input-icon icon-username"></div>
              <input class="form-control" id="answer" name="answer" placeholder="Svar på frågan" tabindex="2" type="text" />
            </div>
